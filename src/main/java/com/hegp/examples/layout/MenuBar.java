...
public class MenuBar extends JMenuBar {// 菜单栏
	...
	public JMenuItem getJinhuoItem() {
		if (jinhuoItem == null) {
			...
			jinhuoItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
	...
	public JMenuItem getJinhuo_tuihuoItem() {
		if (jinhuo_tuihuoItem == null) {
			...
			jinhuo_tuihuoItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
	...
	private JMenuItem getGuanyu_Item() {
		if (guanyu_Item == null) {
			...
			guanyu_Item.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
			ImageIcon aboutImage = new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png");
	...
	public JMenuItem getBugItem() {
		if (bugItem == null) {
			...
			bugItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
	...
	public JMenuItem getFangwen_wangzhanItem() {
		if (fangwen_wangzhanItem == null) {
			...
			fangwen_wangzhanItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
	...
	public JMenuItem getXiaoshou_danItem() {
		if (xiaoshou_danItem == null) {
			...
			xiaoshou_danItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
	...
	public JMenuItem getXiaoshou_tuihuoItem() {
		if (xiaoshou_tuihuoItem == null) {
			...
			xiaoshou_tuihuoItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
			xiaoshou_tuihuoItem.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					createIFrame(xiaoshou_tuihuoItem, JinHuoDanIFrame.class);
				}
			});
		}
	...
	public JMenuItem getKucun_pandianItem() {
		if (kucun_pandianItem == null) {
			...
			kucun_pandianItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
			kucun_pandianItem.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					createIFrame(kucun_pandianItem, JinHuoDanIFrame.class);
				}
			});
		}
	...
	public JMenuItem getJiage_tiaozhengItem() {
		if (jiage_tiaozhengItem == null) {
			...
			jiage_tiaozhengItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
			jiage_tiaozhengItem.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					createIFrame(jiage_tiaozhengItem, JinHuoDanIFrame.class);
				}
			});
		}
	...
	public JMenuItem getXiaoshou_chaxunItem() {
		if (xiaoshou_chaxunItem == null) {
			...
			xiaoshou_chaxunItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
	...
	public JMenuItem getShangpin_chaxunItem() {
		if (shangpin_chaxunItem == null) {
			...
			shangpin_chaxunItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
	...
	public JMenuItem getXiaoshou_paihangItem() {
		if (xiaoshou_paihangItem == null) {
			...
			xiaoshou_paihangItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
	...
	public JMenuItem getShangpin_guanliItem() {
		if (shangpin_guanliItem == null) {
			...
			shangpin_guanliItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
			shangpin_guanliItem.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					createIFrame(shangpin_guanliItem, JinHuoDanIFrame.class);
				}
			});
		}
	...
	public JMenuItem getKehu_guanliItem() {
		if (kehu_guanliItem == null) {
			...
			kehu_guanliItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
			kehu_guanliItem.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					createIFrame(kehu_guanliItem, JinHuoDanIFrame.class);
				}
			});
		}
	...
	public JMenuItem getGys_guanliItem() {
		if (gys_guanliItem == null) {
			...
			gys_guanliItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
			gys_guanliItem.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					createIFrame(gys_guanliItem, JinHuoDanIFrame.class);
				}
			});
		}
	...
	public JMenuItem getJsr_guanliItem() {
		if (jsr_guanliItem == null) {
			...
			jsr_guanliItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
			jsr_guanliItem.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					createIFrame(jsr_guanliItem, JinHuoDanIFrame.class);
				}
			});
		}
	...
	public JMenuItem getMima_xiugaiItem() {
		if (mima_xiugaiItem == null) {
			...
			mima_xiugaiItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
			mima_xiugaiItem.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					createIFrame(mima_xiugaiItem, JinHuoDanIFrame.class);
				}
			});
		}
	...
	public JMenuItem getShuju_beifenItem() {
		if (shuju_beifenItem == null) {
			...
			shuju_beifenItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
			shuju_beifenItem.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					createIFrame(shuju_beifenItem, JinHuoDanIFrame.class);
				}
			});
		}
	...
	public JMenuItem getExitItem() {
		if (exitItem == null) {
			...
			exitItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
	...
	public JMenuItem getPingpuItem() {
		if (pingpuItem == null) {
			...
			pingpuItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
	...
	private JMenuItem getClassAllItem() {
		if (closeAllItem == null) {
			...
			closeAllItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
	...
	private JMenuItem getAllIconItem() {
		if (allIconItem == null) {
			...
			allIconItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
	...
	private JMenuItem getAllResumeItem() {
		if (allResumeItem == null) {
			...
			allResumeItem.setIcon(new ImageIcon("/home/hgp/aa/res/icon/jinhuodan.png"));
